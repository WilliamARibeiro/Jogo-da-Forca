...
var fruits = ['Maça', 'Banana', 'Abacaxi', 'Uva', 'Mamao', 'Morango','Melancia']
var paises = ['Brasil', 'Alemanha', 'Holanda','Inglaterra', 'Russia', 'Canada', 'China', 'Portugal']
var splitword
var addword = []
var letter = []
var letterOFF = []
...
function refreshScreen() {
  document.querySelector('.botao__play').style.display = 'initial'
  document.querySelector('.botao__addPalavra').style.display = 'initial'
  document.querySelector('.botao__novoJogo').style.display = 'none'
  document.querySelector('.botao__desistir').style.display = 'none'
...
function screenGame() {
  document.querySelector('.botao__play').style.display = 'none'
  document.querySelector('.botao__addPalavra').style.display = 'none'
  document.querySelector('.botao__novoJogo').style.display = 'initial'
  document.querySelector('.botao__desistir').style.display = 'initial'
